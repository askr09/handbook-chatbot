...
if not CHROMA_PATH.exists():
    CHROMA_PATH = Path(os.getcwd()) / "chroma_db"
chroma_client = chromadb.PersistentClient(path=str(CHROMA_PATH))
handbook_collection  = chroma_client.get_or_create_collection("handbook")
direction_collection = chroma_client.get_or_create_collection("direction")
